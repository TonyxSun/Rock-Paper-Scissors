...
function start(){
    introClick.classList.add('hidden');
...
let printRound = function (msg) {
    ...
    roundResults.innerHTML = `Round ${roundNumber}: You chose: ${playerSelection}. EvilBot chose: ${computerSelection}.\n <strong>${msg}</strong>`;
...
let printWinner = function () {
    ...
    if (playerScore > computerScore){
        ...
        msg = "Sorry, you lost. You will find your hard drive filled with pictures of 'pie' when you wake up tomorrow. Condolences.\n";
    }
